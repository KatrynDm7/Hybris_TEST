				...
				<tr class="cartItem">
					...
					<td headers="header4" class="quantity">
						...
						<form:form id="updateCartForm${entry.entryNumber}" action="${cartUpdateFormAction}" method="post" commandName="updateQuantityForm${entry.entryNumber}"
							           data-cart='{"cartCode" : "${cartData.code}","productPostPrice":"${entry.totalPrice.value}","productName":"${entry.product.code}"}'>
							...
							<c:choose>
								...
								<c:otherwise>
									...
									<ycommerce:testId code="cart_product_updateQuantity">
										<div id="QuantityProduct_${entry.entryNumber}" class="updateQuantityProduct"></a>
									</ycommerce:testId>
								</c:otherwise>
							</c:choose>
					...
					<td headers="header6" class="total">
						<ycommerce:testId code="cart_totalProductPrice_label">
							<c:if test="${cartData.backendDown == false}" >
