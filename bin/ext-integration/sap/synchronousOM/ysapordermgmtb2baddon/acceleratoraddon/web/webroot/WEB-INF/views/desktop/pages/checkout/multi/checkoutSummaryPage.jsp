...
<template:page pageTitle="${pageTitle}" hideHeaderLinks="true">
	...
	<div id="placeOrder" class="span-14 append-1">
		<addon:summaryFlow deliveryAddress="${cartData.deliveryAddress}" deliveryMode="${deliveryMode}" paymentInfo="${paymentInfo}" requestSecurityCode="${requestSecurityCode}" cartData="${cartData}"/>
