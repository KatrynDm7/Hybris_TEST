...
"cartAnalyticsData":{"cartCode" : "${cartCode}","productPostPrice":"${entry.totalPrice.value}","productName":"${product.name}"}
,
...
<div class="popupCartItem">
	...
	<div class="itemDesc">
		...
		<div class="itemPrice"><format:price priceData="${entry.totalPrice}"/></div>
	</div>
</div>	
