 ...
 *
 */
package de.hybris.platform.sap.sapordermgmthmc.jalo;
...
import de.hybris.platform.sap.sapordermgmthmc.constants.SapordermgmthmcConstants;



/**
 * This is the extension manager of the Sapordermgmthmc extension.
 */
public class SapordermgmthmcManager extends GeneratedSapordermgmthmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapordermgmthmcManager.class.getName());
	 ...
	 */
	public static SapordermgmthmcManager getInstance()
	{
		return (SapordermgmthmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapordermgmthmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapordermgmthmcManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapordermgmthmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapordermgmthmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapordermgmthmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
