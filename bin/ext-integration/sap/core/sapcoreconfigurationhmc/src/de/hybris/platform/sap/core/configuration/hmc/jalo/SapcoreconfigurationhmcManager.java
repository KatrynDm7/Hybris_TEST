 ...
 *
 */
package de.hybris.platform.sap.core.configuration.hmc.jalo;
...
/**
 * This is the extension manager of the Sapcoreconfigurationhmc extension.
 */
public class SapcoreconfigurationhmcManager extends GeneratedSapcoreconfigurationhmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcoreconfigurationhmcManager.class.getName());
	 ...
	 */
	public static SapcoreconfigurationhmcManager getInstance()
	{
		return (SapcoreconfigurationhmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapcoreconfigurationhmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcoreconfigurationhmcManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcoreconfigurationhmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapcoreconfigurationhmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapcoreconfigurationhmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
