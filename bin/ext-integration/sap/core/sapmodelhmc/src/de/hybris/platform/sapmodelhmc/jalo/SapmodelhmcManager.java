 ...
 *
 */
package de.hybris.platform.sapmodelhmc.jalo;
...
import de.hybris.platform.sapmodelhmc.constants.SapmodelhmcConstants;



/**
 * This is the extension manager of the Sapmodelhmc extension.
 */
public class SapmodelhmcManager extends GeneratedSapmodelhmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapmodelhmcManager.class.getName());
	 ...
	 */
	public static SapmodelhmcManager getInstance()
	{
		return (SapmodelhmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapmodelhmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapmodelhmcManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapmodelhmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapmodelhmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapmodelhmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
