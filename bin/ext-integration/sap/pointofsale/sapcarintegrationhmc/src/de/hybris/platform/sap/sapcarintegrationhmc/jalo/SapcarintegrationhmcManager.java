 ...
 *  
 */
package de.hybris.platform.sap.sapcarintegrationhmc.jalo;
...
import de.hybris.platform.sap.sapcarintegrationhmc.constants.SapcarintegrationhmcConstants;



/**
 * This is the extension manager of the Sapcarintegrationhmc extension.
 */
public class SapcarintegrationhmcManager extends GeneratedSapcarintegrationhmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcarintegrationhmcManager.class.getName());
	 ...
	 */
	public static SapcarintegrationhmcManager getInstance()
	{
		return (SapcarintegrationhmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapcarintegrationhmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcarintegrationhmcManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcarintegrationhmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapcarintegrationhmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapcarintegrationhmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
