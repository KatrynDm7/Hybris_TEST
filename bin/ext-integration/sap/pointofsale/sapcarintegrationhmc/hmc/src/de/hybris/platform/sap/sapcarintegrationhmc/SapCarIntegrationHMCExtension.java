package de.hybris.platform.sap.sapcarintegrationhmc;
 ...
 */
public class SapCarIntegrationHMCExtension extends HMCExtension
{
	/**
	 * Edit the local|project.properties to change logging behavior (properties log4j.*).
	 */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(SapCarIntegrationHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "localization.sapcarintegrationhmc-locales";
