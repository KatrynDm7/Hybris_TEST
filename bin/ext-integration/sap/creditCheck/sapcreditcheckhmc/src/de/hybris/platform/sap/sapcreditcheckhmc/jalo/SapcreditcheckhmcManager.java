 ...
 *  
 */
package de.hybris.platform.sap.sapcreditcheckhmc.jalo;
...
import de.hybris.platform.sap.sapcreditcheckhmc.constants.SapcreditcheckhmcConstants;



/**
 * This is the extension manager of the Sapcreditcheckhmc extension.
 */
public class SapcreditcheckhmcManager extends GeneratedSapcreditcheckhmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcreditcheckhmcManager.class.getName());
	 ...
	 */
	public static SapcreditcheckhmcManager getInstance()
	{
		return (SapcreditcheckhmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapcreditcheckhmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcreditcheckhmcManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcreditcheckhmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapcreditcheckhmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapcreditcheckhmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
