...
package de.hybris.platform.sap.sapcreditcheckhmc;
...
/**
 * Provides necessary meta information about the sapcreditcheckhmc hmc extension.
 *
 *
 * @version ExtGen v4.1
 */
public class SapcreditcheckHMCExtension extends HMCExtension
{
	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "localization.sapcreditcheckhmc-locales";
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(SapcreditcheckHMCExtension.class.getName());
