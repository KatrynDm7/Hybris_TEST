...
public class DefaultSapB2BCheckoutFacade extends DefaultB2BCheckoutFacade {

	static final private Logger sapLogger = Logger.getLogger(DefaultSapB2BCheckoutFacade.class.getName());
