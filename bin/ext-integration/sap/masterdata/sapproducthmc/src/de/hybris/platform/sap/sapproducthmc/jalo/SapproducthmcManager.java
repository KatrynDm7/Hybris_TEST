 ...
 *
 */
package de.hybris.platform.sap.sapproducthmc.jalo;
...
import de.hybris.platform.sap.sapproducthmc.constants.SapproducthmcConstants;



/**
 * This is the extension manager of the Sapproducthmc extension.
 */
public class SapproducthmcManager extends GeneratedSapproducthmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapproducthmcManager.class.getName());
	 ...
	 */
	public static SapproducthmcManager getInstance()
	{
		return (SapproducthmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapproducthmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapproducthmcManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapproducthmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapproducthmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapproducthmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
