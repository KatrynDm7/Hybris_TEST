...
package de.hybris.platform.sap.sapproductavailabilityhmc;
...
/**
 * Provides necessary meta information about the sapproductavailabilityhmc hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class SapproductavailabilityHMCExtension extends HMCExtension
{
	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "localization.sapproductavailabilityhmc-locales";
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(SapproductavailabilityHMCExtension.class.getName());
