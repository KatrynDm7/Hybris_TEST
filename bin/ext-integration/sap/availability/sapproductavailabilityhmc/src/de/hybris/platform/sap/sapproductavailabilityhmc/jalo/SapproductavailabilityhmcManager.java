...
package de.hybris.platform.sap.sapproductavailabilityhmc.jalo;
...
import de.hybris.platform.sap.sapproductavailabilityhmc.constants.SapproductavailabilityhmcConstants;
import de.hybris.platform.sap.sapproductavailabilityhmc.jalo.GeneratedSapproductavailabilityhmcManager;



/**
 * This is the extension manager of the Sapproductavailabilityhmc extension.
 */
public class SapproductavailabilityhmcManager extends GeneratedSapproductavailabilityhmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapproductavailabilityhmcManager.class.getName());
	 ...
	 */
	public static SapproductavailabilityhmcManager getInstance()
	{
		return (SapproductavailabilityhmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapproductavailabilityhmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapproductavailabilityhmcManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapproductavailabilityhmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapproductavailabilityhmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapproductavailabilityhmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
