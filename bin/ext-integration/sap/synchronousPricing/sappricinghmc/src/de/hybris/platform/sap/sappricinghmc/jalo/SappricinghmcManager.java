 ...
 *
 */
package de.hybris.platform.sap.sappricinghmc.jalo;
...
import de.hybris.platform.sap.sappricinghmc.constants.SappricinghmcConstants;



/**
 * This is the extension manager of the Sappricinghmc extension.
 */
public class SappricinghmcManager extends GeneratedSappricinghmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SappricinghmcManager.class.getName());
	 ...
	 */
	public static SappricinghmcManager getInstance()
	{
		return (SappricinghmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SappricinghmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SappricinghmcManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SappricinghmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SappricinghmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SappricinghmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
