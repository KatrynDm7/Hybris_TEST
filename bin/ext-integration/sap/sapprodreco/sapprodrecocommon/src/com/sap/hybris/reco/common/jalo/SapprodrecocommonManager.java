 ...
 *
 */
package com.sap.hybris.reco.common.jalo;
...
import com.sap.hybris.reco.common.constants.SapprodrecocommonConstants;
import com.sap.hybris.reco.common.jalo.GeneratedSapprodrecocommonManager;



/**
 * This is the extension manager of the SapprodrecocommonManager extension.
 */
public class SapprodrecocommonManager extends GeneratedSapprodrecocommonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapprodrecocommonManager.class.getName());
	 ...
	 */
	public static SapprodrecocommonManager getInstance()
	{
		return (SapprodrecocommonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapprodrecocommonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapprodrecocommonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapprodrecocommonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapproductrecommendationManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapproductrecommendationManager called, current tenant: " + getTenant().getTenantID());
		}
	}
