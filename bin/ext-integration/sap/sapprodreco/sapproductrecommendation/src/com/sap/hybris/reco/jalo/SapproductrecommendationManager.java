 ...
 *
 */
package com.sap.hybris.reco.jalo;
...
/**
 * This is the extension manager of the Sapproductrecommendation extension.
 */
public class SapproductrecommendationManager extends GeneratedSapproductrecommendationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapproductrecommendationManager.class.getName());
	 ...
	 */
	public static SapproductrecommendationManager getInstance()
	{
		return (SapproductrecommendationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapproductrecommendationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapproductrecommendationManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapproductrecommendationManager called.");
		}
	}
