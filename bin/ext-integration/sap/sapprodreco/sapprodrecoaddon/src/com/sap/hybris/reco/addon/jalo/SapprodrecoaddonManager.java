 ...
 *
 */
package com.sap.hybris.reco.addon.jalo;
...
import com.sap.hybris.reco.addon.jalo.GeneratedSapprodrecoaddonManager;



/**
 * 
 * This is the extension manager of the SapprodrecoaddonManager extension.
 */
public class SapprodrecoaddonManager extends GeneratedSapprodrecoaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapprodrecoaddonManager.class.getName());
	 ...
	 */
	public static SapprodrecoaddonManager getInstance()
	{
		return (SapprodrecoaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapprodrecoaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapprodrecoaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapprodrecoaddonManager called.");
		}
	}
