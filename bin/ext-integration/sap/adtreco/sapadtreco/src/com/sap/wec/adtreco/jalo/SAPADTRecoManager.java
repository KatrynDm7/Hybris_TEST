 ...
 *
 */
package com.sap.wec.adtreco.jalo;
...
/**
 * This is the extension manager of the Sapadtreco extension.
 */
public class SAPADTRecoManager extends GeneratedSAPADTRecoManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SAPADTRecoManager.class.getName());
	 ...
	 */
	public static SAPADTRecoManager getInstance()
	{
		return (SAPADTRecoManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapadtrecoConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SAPADTRecoManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapadtrecoManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapadtrecoManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapadtrecoManager called, current tenant: " + getTenant().getTenantID());
		}
	}
