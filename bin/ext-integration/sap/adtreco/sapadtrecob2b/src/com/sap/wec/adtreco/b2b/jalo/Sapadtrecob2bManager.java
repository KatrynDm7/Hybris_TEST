 ...
 *
 */
package com.sap.wec.adtreco.b2b.jalo;
...
import com.sap.wec.adtreco.b2b.constants.Sapadtrecob2bConstants;



/**
 * This is the extension manager of the Sapadtrecob2b extension.
 */
public class Sapadtrecob2bManager extends GeneratedSapadtrecob2bManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Sapadtrecob2bManager.class.getName());
	 ...
	 */
	public static Sapadtrecob2bManager getInstance()
	{
		return (Sapadtrecob2bManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Sapadtrecob2bConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Sapadtrecob2bManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Sapadtrecob2bManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Sapadtrecob2bManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Sapadtrecob2bManager called, current tenant: " + getTenant().getTenantID());
		}
	}
