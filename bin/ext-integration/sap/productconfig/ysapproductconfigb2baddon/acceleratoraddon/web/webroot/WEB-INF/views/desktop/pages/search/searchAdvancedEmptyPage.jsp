...
<%@ taglib prefix="addonProduct" tagdir="/WEB-INF/tags/addons/b2bacceleratoraddon/desktop/product"%>
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags"%>
<%@ taglib prefix="cms" uri="http://hybris.com/tld/cmstags"%>
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
<%@ taglib prefix="nav" tagdir="/WEB-INF/tags/addons/b2bacceleratoraddon/desktop/nav"%>
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions"%>
<%@ taglib prefix="common" tagdir="/WEB-INF/tags/desktop/common"%>
<%@ taglib prefix="breadcrumb" tagdir="/WEB-INF/tags/desktop/nav/breadcrumb"%>
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form"%>
<%@ taglib prefix="formElement" tagdir="/WEB-INF/tags/desktop/formElement"%>
<%@ taglib prefix="addonFormElement" tagdir="/WEB-INF/tags/addons/b2bacceleratoraddon/desktop/formElement"%>
...
<template:page pageTitle="${pageTitle}">
	<jsp:attribute name="pageScripts">
		<script type="text/javascript" src="${contextPath}/_ui/addons/b2bacceleratoraddon/desktop/common/js/acc.productlisting.js"></script>
	...
	<jsp:body>
		...
		<div class="span-24">
			...
			<c:if test="${ not advancedSearchForm.catalogSearchResultType}">
				...
				<div class="headline"><spring:theme code="search.advanced" /> xxx </div>
					...
					<div class="advancedSearchSection clearfix">
						...
						<form:form action="${advancedSearchUrl}" method="get" name="advancedSearchForm" commandName="advancedSearchForm">
							...
							<div class="searchInput">	
								...
								<button id="js-add-product-ids"  type="submit"><spring:theme code="search.advanced.productids.add" /></button>
							</div>
							
							<sec:authorize ifAnyGranted="ROLE_CUSTOMERGROUP">
								<div class="radios clearfix right">
									<addonFormElement:formRadioBoxLeft idKey="search-order-form" labelKey="search.advanced.orderform" value="order-form" path="searchResultType" />
									<addonFormElement:formRadioBoxLeft idKey="search-create-order-form" labelKey="search.advanced.createorderform" value="create-order-form" path="searchResultType" />
									<addonFormElement:formRadioBoxLeft idKey="search-catalog" labelKey="search.advanced.catalog" value="catalog" path="searchResultType" />
								</div>
							</sec:authorize>
							...
							<div class="searchButton">
								...
								<button class="positive adv_search_button" type="submit"><spring:theme code="search.advanced.search" /></button>
							</div>
						</form:form>
					</div>
				...
				<c:if test="${advancedSearchForm.orderFormSearchResultType}">
					...
					<form name="AddToCartOrderForm" id="AddToCartOrderForm" class="add_to_cart_order_form" action="${addToCartGridUrl}" method="post" data-grid-confirm-message="${gridConfirmMessage}">
