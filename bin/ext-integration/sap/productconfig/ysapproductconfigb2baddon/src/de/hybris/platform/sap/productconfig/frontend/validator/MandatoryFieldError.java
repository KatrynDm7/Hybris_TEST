...
public class MandatoryFieldError extends FieldError
{
	private final CsticData cstic;

	public MandatoryFieldError(final CsticData cstic, final String fieldName, final String rejectedValue,
			final String[] errorCodes, final String defaultMessage)
	{
		super(Sapproductconfigb2baddonConstants.CONFIG_ATTRIBUTE, fieldName, rejectedValue, false, errorCodes, null, defaultMessage);
