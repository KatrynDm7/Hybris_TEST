...
public class SapproductconfighmcManager extends GeneratedSapproductconfighmcManager
{
	...
	{
		return (SapproductconfighmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapproductconfighmcConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapproductconfighmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapproductconfighmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
