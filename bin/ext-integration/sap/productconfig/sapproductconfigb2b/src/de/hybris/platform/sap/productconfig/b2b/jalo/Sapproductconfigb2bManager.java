...
/**
 * This is the extension manager of the Sapproductconfigb2b extension.
 */
public class Sapproductconfigb2bManager extends GeneratedSapproductconfigb2bManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Sapproductconfigb2bManager.class.getName());
	 ...
	 */
	public static Sapproductconfigb2bManager getInstance()
	{
		return (Sapproductconfigb2bManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Sapproductconfigb2bConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Sapproductconfigb2bManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Sapproductconfigb2bManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Sapproductconfigb2bManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Sapproductconfigb2bManager called, current tenant: " + getTenant().getTenantID());
		}
	}
