...
/**
 * This is the extension manager of the Sapproductconfigruntimeinterface extension.
 */
public class SapproductconfigruntimeinterfaceManager extends GeneratedSapproductconfigruntimeinterfaceManager
{
	...
	private static final Logger LOG = Logger.getLogger(SapproductconfigruntimeinterfaceManager.class.getName());
	 ...
	 */
	public static SapproductconfigruntimeinterfaceManager getInstance()
	{
		return (SapproductconfigruntimeinterfaceManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapproductconfigruntimeinterfaceConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapproductconfigruntimeinterfaceManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapproductconfigruntimeinterfaceManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapproductconfigruntimeinterfaceManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapproductconfigruntimeinterfaceManager called, current tenant: " + getTenant().getTenantID());
		}
	}
