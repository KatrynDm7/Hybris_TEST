...
import de.hybris.platform.sap.productconfig.runtime.ssc.jalo.GeneratedSapproductconfigruntimesscManager;




/**
 * This is the extension manager of the Sapproductconfigruntimessc extension.
 */
public class SapproductconfigruntimesscManager extends GeneratedSapproductconfigruntimesscManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapproductconfigruntimesscManager.class.getName());
	 ...
	 */
	public static SapproductconfigruntimesscManager getInstance()
	{
		return (SapproductconfigruntimesscManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapproductconfigruntimesscConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapproductconfigruntimesscManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapproductconfigruntimesscManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapproductconfigruntimesscManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapproductconfigruntimesscManager called, current tenant: " + getTenant().getTenantID());
		}
	}
