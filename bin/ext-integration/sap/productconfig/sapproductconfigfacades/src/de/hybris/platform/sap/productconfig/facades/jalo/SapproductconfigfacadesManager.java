...
/**
 * This is the extension manager of the Sapproductconfigfacades extension.
 */
public class SapproductconfigfacadesManager extends GeneratedSapproductconfigfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapproductconfigfacadesManager.class.getName());
	 ...
	 */
	public static SapproductconfigfacadesManager getInstance()
	{
		return (SapproductconfigfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapproductconfigfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapproductconfigfacadesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapproductconfigfacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapproductconfigfacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapproductconfigfacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
