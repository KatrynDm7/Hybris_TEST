...
/**
 * This is the extension manager of the Sapproductconfigservices extension.
 */
public class SapproductconfigservicesManager extends GeneratedSapproductconfigservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapproductconfigservicesManager.class.getName());
	 ...
	 */
	public static SapproductconfigservicesManager getInstance()
	{
		return (SapproductconfigservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapproductconfigservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapproductconfigservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapproductconfigservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapproductconfigservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapproductconfigservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
