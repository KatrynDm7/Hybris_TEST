package de.hybris.platform.sap.sapproductconfigbackoffice.pricing;
...
public class BackofficePricingConfigurationParameter implements PricingConfigurationParameter
{
	private static final Logger LOG = Logger.getLogger(BackofficePricingConfigurationParameter.class);
		...
		try
		{
					...
					&& !moduleConfigurationAccess.getSAPConfigurationName().isEmpty())
			{
				final Object propertyValue = moduleConfigurationAccess
						.getProperty(SapproductconfigbackofficeConstants.CONFIGURATION_PRICING_SUPPORTED);
	...
	public String getTargetForBasePrice()
	{
		...
		{
			final Object propertyValue = moduleConfigurationAccess
					.getProperty(SapproductconfigbackofficeConstants.CONFIGURATION_CONDITION_FUNCTION_BASE_PRICE);
	...
	public String getTargetForSelectedOptions()
	{
		...
		{
			final Object propertyValue = moduleConfigurationAccess
					.getProperty(SapproductconfigbackofficeConstants.CONFIGURATION_CONDITION_FUNCTION_SECLECTED_OPTIONS);
	...
	public String getPricingProcedure()
	{
		...
		{
			final Object propertyValue = moduleConfigurationAccess
					.getProperty(SapproductconfigbackofficeConstants.CONFIGURATION_PRICING_PROCEDURE);
