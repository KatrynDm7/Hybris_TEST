...
public class SapproductconfigbackofficeManager extends GeneratedSapproductconfigbackofficeManager
{
	...
	private static final Logger LOG = Logger.getLogger(SapproductconfigbackofficeManager.class.getName());
	 ...
	 */
	public static SapproductconfigbackofficeManager getInstance()
	{
		return (SapproductconfigbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapproductconfigbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapproductconfigbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapproductconfigbackofficeManager called.");
		}
	}
