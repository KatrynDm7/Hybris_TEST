...
/**
 * This is the extension manager of the Sapproductconfigmodel extension.
 */
public class SapproductconfigmodelManager extends GeneratedSapproductconfigmodelManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapproductconfigmodelManager.class.getName());
	 ...
	 */
	public static SapproductconfigmodelManager getInstance()
	{
		return (SapproductconfigmodelManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapproductconfigmodelConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapproductconfigmodelManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapproductconfigmodelManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapproductconfigmodelManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapproductconfigmodelManager called, current tenant: " + getTenant().getTenantID());
		}
	}
