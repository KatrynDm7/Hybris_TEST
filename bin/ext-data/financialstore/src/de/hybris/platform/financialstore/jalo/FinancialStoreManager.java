 ...
 *  
 */
package de.hybris.platform.financialstore.jalo;
...
/**
 * This is the extension manager of the financialstore extension.
 */
public class FinancialStoreManager extends GeneratedFinancialStoreManager
{
	 ...
	 */
	private static final Logger LOG = Logger.getLogger(FinancialStoreManager.class.getName());
	...
	{
		return (FinancialStoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(FinancialStoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public FinancialStoreManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of FinancialStoreManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of FinancialStoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of FinancialStoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
