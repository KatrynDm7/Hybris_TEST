 ...
 */
public class ApparelstoreManager extends GeneratedApparelstoreManager
{
	/**
	 * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
	 */
	private static final Logger LOG = Logger.getLogger(ApparelstoreManager.class.getName());
	 ...
	 */
	public static ApparelstoreManager getInstance()
	{
		return (ApparelstoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ApparelstoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ApparelstoreManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ApparelstoreManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ApparelstoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ApparelstoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
