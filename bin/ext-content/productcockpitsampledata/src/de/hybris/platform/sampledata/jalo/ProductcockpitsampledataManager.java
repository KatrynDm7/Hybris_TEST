 ...
 */
package de.hybris.platform.sampledata.jalo;
...
/**
 * This is the extension manager of the Productcockpitsampledata extension.
 */
public class ProductcockpitsampledataManager extends GeneratedProductcockpitsampledataManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ProductcockpitsampledataManager.class.getName());
	 ...
	 */
	public static ProductcockpitsampledataManager getInstance()
	{
		return (ProductcockpitsampledataManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ProductcockpitsampledataConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ProductcockpitsampledataManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ProductcockpitsampledataManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ProductcockpitsampledataManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ProductcockpitsampledataManager called, current tenant: " + getTenant().getTenantID());
		}
	}
