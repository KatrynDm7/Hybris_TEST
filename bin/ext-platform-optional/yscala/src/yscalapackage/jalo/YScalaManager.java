...
import yscalapackage.constants.YScalaConstants;



/**
 * This is the extension manager of the YScala extension.
 */
public class YScalaManager extends GeneratedYScalaManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(YScalaManager.class.getName());
	 ...
	 */
	public static YScalaManager getInstance()
	{
		return (YScalaManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				YScalaConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public YScalaManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of YScalaManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of YScalaManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of YScalaManager called, current tenant: " + getTenant().getTenantID());
		}
	}
