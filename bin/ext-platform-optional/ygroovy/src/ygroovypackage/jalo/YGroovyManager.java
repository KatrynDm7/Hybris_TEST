...
import ygroovypackage.constants.YGroovyConstants;



/**
 * This is the extension manager of the YGroovy extension.
 */
public class YGroovyManager extends GeneratedYGroovyManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(YGroovyManager.class.getName());
	 ...
	 */
	public static YGroovyManager getInstance()
	{
		return (YGroovyManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				YGroovyConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public YGroovyManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of YGroovyManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of YGroovyManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of YGroovyManager called, current tenant: " + getTenant().getTenantID());
		}
	}
