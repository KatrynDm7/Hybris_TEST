...
%>
				<td style="width:<%= widthSearchButt %>px;">
					<div class="button-on-white chip-event" style="width:<%= widthSearchButt %>px;">
						<a href="#" title="<%= localized("upload") %>" hidefocus="true"
							name="<%= theChip.getCommandID(UploadToMediaEditorChip.UPLOAD) %>">
							<span id="<%= theChip.getUniqueName() %>_uploadspan">
								<img class="icon" src="images/icons/valueeditor_upload.gif" id="<%= theChip.getUniqueName() %>_uploading"/>
							</span>
						</a>
					</div>
				</td>
...
%>
				<td style="width:<%= widthSearchButt %>px;">
					<div style="width:<%= widthSearchButt %>px;">
						<a href="<%=((Media) theChip.getValue()).getURL()%>" title="<%= localized("download") %>" hidefocus="true">
							<span>
