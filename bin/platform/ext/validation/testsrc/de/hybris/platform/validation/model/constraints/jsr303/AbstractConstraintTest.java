...
public abstract class AbstractConstraintTest extends ServicelayerTransactionalTest
{
	...
	protected void checkException(final Throwable exeption, final Class mainException, final Class innerException,
			final Class interceptor)
	{
		assertEquals(mainException, exeption.getClass());
		assertEquals(innerException, exeption.getCause().getClass());
		if (InterceptorException.class.equals(innerException))
		{
			final InterceptorException interceptorException = (InterceptorException) exeption.getCause();
