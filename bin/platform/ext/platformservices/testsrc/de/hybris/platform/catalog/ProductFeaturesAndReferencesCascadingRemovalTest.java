...
public class ProductFeaturesAndReferencesCascadingRemovalTest extends ServicelayerBaseTest
{
	...
	public void shouldRemoveFeaturesOfRemovedProductAndReferencesToThisProduct() throws Exception
	{
		...
		final ProductFeatureModel feature1 = createProductFeatureForProduct(productToBeRemoved, "feature1");
		final ProductFeatureModel feature2 = createProductFeatureForProduct(productToBeRemoved, "feature2");
