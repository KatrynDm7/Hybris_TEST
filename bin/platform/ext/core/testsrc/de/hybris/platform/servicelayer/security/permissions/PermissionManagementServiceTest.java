...
@IntegrationTest
public class PermissionManagementServiceTest extends AbstractPermissionServiceTest
{
	private static final Logger LOG = Logger.getLogger(PermissionManagementServiceTest.class);
