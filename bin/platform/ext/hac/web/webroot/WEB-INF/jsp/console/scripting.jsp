					...
					<div id="tabs-edit">
						...
						<form action="<c:url value="/console/scripting/save" />" method="post">
                            Script type: <select id="scriptType" name="scriptType"><c:choose><c:when test="${scriptData != null && scriptData.getContent() != null}">
                                <option value="${scriptData.getContent().getEngineName()}"><c:out value="${scriptData.getContent().getEngineName()}"/></option>
                            ...
                            <div style="float: right;margin-right: 10px">code:<c:choose><c:when test="${scriptData != null && scriptData.getContent() != null}"><input type="text" id="code" name="code" value="${scriptData.getCode()}"></c:when><c:otherwise><input type="text" id="code" name="code"></c:otherwise></c:choose>
                            ...
                            <div id="textarea-container">
                                ...
                                <textarea id="script" name="script"><c:choose><c:when test="${scriptData != null && scriptData.getContent() != null}">${scriptData.getContent().getContent()}</c:when><c:otherwise>
...
return "Groovy Rocks!"</c:otherwise></c:choose></textarea>
                    ...
                    <div id="tabs-browse" >
                        ...
                        <form:form method="post" action="${fileImportUrl}?${_csrf.parameterName}=${_csrf.token}" commandName="scriptFileFormData"
