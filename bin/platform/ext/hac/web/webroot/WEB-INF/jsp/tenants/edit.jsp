				...
				<div class="quiet">
					...
					<hac:note>
						<strong>Configured extensions</strong><br/>
						 ...
						 To find out how to modify the offline extension configuration for given tenant, see <a href="https://wiki.hybris.com/display/release5/Multi-Tenant+Systems">Multi-Tenant Systems document</a>
					...
					<hac:note>
						<strong>Configured web contexts</strong><br/>
						 ...
						 To find out how to configure a web context name for the web application in a specific tenant, see <a href="https://wiki.hybris.com/display/release5/Multi-Tenant+Systems">Multi-Tenant Systems document</a>
