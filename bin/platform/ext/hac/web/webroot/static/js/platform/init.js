$(function() {
	...
	var prepareInitUpdateData = function() {
		...
		postData.dropTables = $('#dropTables').attr('checked') ? true : false;
		postData.clearHMC = $('#clearHMC').attr('checked') ? true : false;
		postData.createEssentialData = $('#createEssentialData').attr('checked') ? true : false;
		postData.localizeTypes = $('#localizeTypes').attr('checked') ? true : false;
		...
		$('#projectData input[type=text]').each(function (e) {
	...
	function toggleProjectData() {
		var checked = $('#toggleAll').attr('checked') ? true : false;
