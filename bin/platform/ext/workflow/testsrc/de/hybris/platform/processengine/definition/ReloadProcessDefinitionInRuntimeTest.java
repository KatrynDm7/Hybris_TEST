...
public class ReloadProcessDefinitionInRuntimeTest extends ServicelayerBaseTest
{
	...
	@Test
	public void processShouldContinueWithOldDefinition() throws InterruptedException
	{
	...
	@Test
	public void processShouldStartWithLatestProcessDefinition() throws InterruptedException
	{
		final ActionsJournal journal = Registry.getApplicationContext().getBean(ActionsJournal.class);
