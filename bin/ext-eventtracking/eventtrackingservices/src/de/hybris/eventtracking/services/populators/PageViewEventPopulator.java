 ...
 *
 */
public class PageViewEventPopulator extends AbstractTrackingEventGenericPopulator
{

	public PageViewEventPopulator(final ObjectMapper mapper)
	{
		super(mapper);
	}
	...
	{
		return PageViewEvent.class.isAssignableFrom(clazz);
	}
			...
			throws ConversionException
	{
		...
		((PageViewEvent) trackingEvent).setEventType("PageViewEvent");	
