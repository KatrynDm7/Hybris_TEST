 ...
 *
 */
public class SearchEventPopulator extends AbstractTrackingEventGenericPopulator
{

	public SearchEventPopulator(final ObjectMapper mapper)
	{
		super(mapper);
	}
	...
	{
		return SearchEvent.class.isAssignableFrom(clazz);
	}
			...
			throws ConversionException
	{
		...
		((SearchEvent) trackingEvent).setSearchTerm(searchTerm);
		((SearchEvent) trackingEvent).setEventType("SearchEvent");	
