 ...
 *
 */
public class ProductDetailPageViewEventPopulator extends AbstractTrackingEventGenericPopulator
{

	public ProductDetailPageViewEventPopulator(final ObjectMapper mapper)
	{
		super(mapper);
	}
	...
	{
		return ProductDetailPageViewEvent.class.isAssignableFrom(clazz);
	}
			...
			throws ConversionException
	{
		...
		((ProductDetailPageViewEvent) trackingEvent).setEventType("ProductDetailPageViewEvent");	
	}
