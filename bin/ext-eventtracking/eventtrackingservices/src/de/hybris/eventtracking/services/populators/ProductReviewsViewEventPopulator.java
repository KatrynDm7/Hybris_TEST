 ...
 *
 */
public class ProductReviewsViewEventPopulator extends AbstractTrackingEventGenericPopulator
{

	public ProductReviewsViewEventPopulator(final ObjectMapper mapper)
	{
		super(mapper);
	}
	...
	{
		return ProductReviewsViewEvent.class.isAssignableFrom(clazz);
	}
			...
			throws ConversionException
	{
		...
		((ProductReviewsViewEvent) trackingEvent).setEventType("ProductReviewsViewEvent");	
	}
