 ...
 *
 */
public class FindStoresNearMeEventPopulator extends AbstractTrackingEventGenericPopulator
{

	public FindStoresNearMeEventPopulator(final ObjectMapper mapper)
	{
		super(mapper);
	}
	...
	{
		return FindStoresNearMeEvent.class.isAssignableFrom(clazz);
	}
			...
			throws ConversionException
	{
		...
		((FindStoresNearMeEvent) trackingEvent).setEventType("FindStoresNearMeEvent");	
	}
