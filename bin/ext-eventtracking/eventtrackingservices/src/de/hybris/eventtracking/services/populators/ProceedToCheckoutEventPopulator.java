 ...
 *
 */
public class ProceedToCheckoutEventPopulator extends AbstractTrackingEventGenericPopulator
{

	public ProceedToCheckoutEventPopulator(final ObjectMapper mapper)
	{
		super(mapper);
	}
	...
	{
		return ProceedToCheckoutEvent.class.isAssignableFrom(clazz);
	}
			...
			throws ConversionException
	{
		...
		((ProceedToCheckoutEvent) trackingEvent).setEventType("ProceedToCheckoutEvent");	
	}
