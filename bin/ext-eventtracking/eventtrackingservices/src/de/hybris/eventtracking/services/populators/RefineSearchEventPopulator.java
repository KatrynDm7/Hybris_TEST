 ...
 *
 */
public class RefineSearchEventPopulator extends AbstractTrackingEventGenericPopulator
{

	public RefineSearchEventPopulator(final ObjectMapper mapper)
	{
		super(mapper);
	}
	...
	{
		return RefineSearchEvent.class.isAssignableFrom(clazz);
	}
			...
			throws ConversionException
	{
		...
		((RefineSearchEvent) trackingEvent).setEventType("RefineSearchEvent");	
