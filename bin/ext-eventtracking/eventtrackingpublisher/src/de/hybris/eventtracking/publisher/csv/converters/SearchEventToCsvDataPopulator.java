 ...
 *
 */
public class SearchEventToCsvDataPopulator implements Populator<AbstractTrackingEvent, TrackingEventCsvData>
{
	...
	{
		if (SearchEvent.class.isAssignableFrom(source.getClass()))
		{
			target.setSearchTerm(((SearchEvent) source).getSearchTerm());
			target.setEventType(((SearchEvent) source).getEventType());
		}
	}
