...
/**
 * This is the extension manager of the YEmpty extension.
 */
public class YEmptyManager extends GeneratedYEmptyManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(YEmptyManager.class.getName());
	 ...
	 */
	public static YEmptyManager getInstance()
	{
		return (YEmptyManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				YEmptyConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public YEmptyManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of YEmptyManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of YEmptyManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of YEmptyManager called, current tenant: " + getTenant().getTenantID());
		}
	}
