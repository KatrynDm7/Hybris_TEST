...
/**
 * Provides necessary meta information about the yaddon hmc extension.
 * 
 * 
 * @version ExtGen v@EXTGEN_VERSION@
 */
public class YAddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(YAddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "yaddonpackage.hmc.locales";
