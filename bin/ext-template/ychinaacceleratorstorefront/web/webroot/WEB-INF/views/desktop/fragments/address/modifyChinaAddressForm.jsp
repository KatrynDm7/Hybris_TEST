...
<form:form commandName="addressForm" class="china_address_form" action="${contextPath}/checkout/multi/edit-address" method="POST">
	<p><spring:theme code="text.checkout.address.modifyAddress" text="Modify Address"/></p>
    ...
    <table border="0" cellpadding="0" cellspacing="0">
    	<tr>
            ...
            <td>
           	    <input type="hidden" id="islocalSubmit" name="islocalSubmit" value="2"/>
          	   	<form:hidden id="address.addressId" path="addressId" mandatory="true"/>
	            <form:input id="address.firstName" labelKey="" path="firstName" cssClass="text" mandatory="true"/>
            	<%-- <formElement:formInputBox idKey="address.firstName" labelKey="" path="firstName" inputCSS="text" mandatory="true"/> --%><span><spring:theme code="cart.step2.deliveryAddress.validation.username.null" text="[ZH VALUE TO BE TRANSLATED]"/></span>
			</td>
		</tr>
        <tr>
        ...
        <tr>
            ...
            <td>
				<form:input id="address.line1" labelKey="" path="line1" cssClass="inputStyle1" mandatory="true"/><span><spring:theme code="cart.step2.deliveryAddress.validation.address.null" text="[ZH VALUE TO BE TRANSLATED]"/></span>
        ...
        <tr>
            ...
            <td>
                ...
                <form:input id="address.landlinePhonePart3" labelKey="" path="landlinePhonePart3" cssClass="inputStyle2" mandatory="true"/><span><spring:theme code="cart.step2.deliveryAddress.validation.phone.invalid" text="[ZH VALUE TO BE TRANSLATED]"/></span>
			</td>

		</tr>
        <tr>
        	<th><span>*</span><spring:theme code="text.checkout.address.mobileNumber" text="Mobile Phone"/></th>
            <td>
            	<%--<formElement:formInputBox idKey="address.cellPhone" labelKey="" path="cellPhone" inputCSS="text" mandatory="true"/>--%>
                <form:input id="address.cellPhone" labelKey="" path="cellPhone" cssClass="text" mandatory="true"/><span><spring:theme code="cart.step2.deliveryAddress.validation.cellphone.invalid" text="[ZH VALUE TO BE TRANSLATED]"/></span>
			</td>
    ...
    <a class="orderConfirm_modifyAddress_saveBtn" href="javascript:void(0);"><spring:theme code="text.checkout.address.save" text="Save Address"/></a>
	<ycommerce:testId code="multicheckout_newaddress_cancel_button">
		<a class="orderConfirm_modifyAddress_cancelBtn" href="javascript:void(0);"><spring:theme code="cnacc.txt.account.address.form.button.cancel" text="Cancel"/></a>
	</ycommerce:testId>
	</div>
	

<script type="text/javascript">
	$('.orderConfirm_modifyAddress_saveBtn').on('click',saveModify);
	function saveModify(){

		var $id = $('.china_address_form input[name="addressId"]');
		...
		$('.orderConfirm_modifyAddress').hide(); // taken from bottom
		return;
	}
	
	$('.orderConfirm_modifyAddress_cancelBtn').click(function(){
		$('.orderConfirm_modifyAddress').hide().empty();
	});
