...
<template:page pageTitle="${pageTitle}">
	...
	<div class="column accountContentPane clearfix">
		<div class="headline"><spring:theme code="text.account.change.mobile.number" text="Profile"/></div>
		<div class="required right"><spring:theme code="form.required" text="Fields marked * are required"/></div>
		<div class="description"><spring:theme code="text.account.profile.updateMobileNumber" text="Enter your new mobile number and confirm with your password"/></div>
		
		<form:form action="update-mobileNumber" method="post" commandName="updateMobileNumberForm">
			...
			<formElement:formInputBox idKey="profile.checkMobileNumber"  labelKey="profile.checkMobileNumber" path="chkMobileNumber" inputCSS="text" mandatory="true"/>
