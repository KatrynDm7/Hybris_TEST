 ...
 *
 */
package de.hybris.platform.yacceleratorcore.hmc;
...
/**
 * Provides necessary meta information about the yacceleratorcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class YAcceleratorCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(YAcceleratorCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "de.hybris.platform.yacceleratorcore.hmc.locales";
