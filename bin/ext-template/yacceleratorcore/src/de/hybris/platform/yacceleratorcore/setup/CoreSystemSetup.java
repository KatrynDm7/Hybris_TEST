...
public class CoreSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		{
			importImpexFile(context, "/yacceleratorcore/import/cockpits/cmscockpit/cmscockpit-users.impex");
			importImpexFile(context, "/yacceleratorcore/import/cockpits/cmscockpit/cmscockpit-access-rights.impex");
		}

		if (importAccessRights && extensionNames.contains("btgcockpit"))
		{
			importImpexFile(context, "/yacceleratorcore/import/cockpits/cmscockpit/btgcockpit-users.impex");
			importImpexFile(context, "/yacceleratorcore/import/cockpits/cmscockpit/btgcockpit-access-rights.impex");
		}

		if (importAccessRights && extensionNames.contains("productcockpit"))
		{
			importImpexFile(context, "/yacceleratorcore/import/cockpits/productcockpit/productcockpit-users.impex");
			importImpexFile(context, "/yacceleratorcore/import/cockpits/productcockpit/productcockpit-access-rights.impex");
			importImpexFile(context, "/yacceleratorcore/import/cockpits/productcockpit/productcockpit-constraints.impex");
		}

		if (importAccessRights && extensionNames.contains("cscockpit"))
		{
			importImpexFile(context, "/yacceleratorcore/import/cockpits/cscockpit/cscockpit-users.impex");
			importImpexFile(context, "/yacceleratorcore/import/cockpits/cscockpit/cscockpit-access-rights.impex");
		}

		if (importAccessRights && extensionNames.contains("reportcockpit"))
		{
			importImpexFile(context, "/yacceleratorcore/import/cockpits/reportcockpit/reportcockpit-users.impex");
			importImpexFile(context, "/yacceleratorcore/import/cockpits/reportcockpit/reportcockpit-access-rights.impex");
		}
