 ...
 *  
 */
package de.hybris.platform.ycommercewebserviceshmc.jalo;
...
import de.hybris.platform.ycommercewebserviceshmc.constants.YcommercewebserviceshmcConstants;
import de.hybris.platform.ycommercewebserviceshmc.jalo.GeneratedYcommercewebserviceshmcManager;



/**
 * This is the extension manager of the Ycommercewebserviceshmc extension.
 */
public class YcommercewebserviceshmcManager extends GeneratedYcommercewebserviceshmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(YcommercewebserviceshmcManager.class.getName());
	 ...
	 */
	public static YcommercewebserviceshmcManager getInstance()
	{
		return (YcommercewebserviceshmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				YcommercewebserviceshmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public YcommercewebserviceshmcManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of YcommercewebserviceshmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of YcommercewebserviceshmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of YcommercewebserviceshmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
