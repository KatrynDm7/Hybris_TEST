 ...
 *  
 */
package de.hybris.platform.ycommercewebservices.hmc;
...
/**
 * Provides necessary meta information about the ycommercewebservices hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class YcommercewebservicesHMCExtension extends HMCExtension
{
	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "de.hybris.platform.ycommercewebservices.hmc.locales";
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(YcommercewebservicesHMCExtension.class.getName());
