  ...
  <body>
    ...
    <div class="container">
      ...
      <form id="loginForm" name="loginForm" class="form-signin" action="<c:url value="/login.do"/>" method="post">
        ...
        <input type="text" name="j_username" class="input-block-level" autocomplete="off" placeholder="Email address">
        <input type="password" name="j_password" class="input-block-level" autocomplete="off" placeholder="Password">
