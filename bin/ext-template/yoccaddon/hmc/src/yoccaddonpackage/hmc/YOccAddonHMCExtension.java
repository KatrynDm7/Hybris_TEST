...
/**
 * Provides necessary meta information about the yoccaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.5.1.0
 */
public class YOccAddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(YOccAddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "yoccaddonpackage.hmc.locales";
