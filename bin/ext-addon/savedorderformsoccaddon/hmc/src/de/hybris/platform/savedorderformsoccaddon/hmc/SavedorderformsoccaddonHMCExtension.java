 ...
 *  
 */
package de.hybris.platform.savedorderformsoccaddon.hmc;
...
/**
 * Provides necessary meta information about the savedorderformsoccaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.4.0.0
 */
public class SavedorderformsoccaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(SavedorderformsoccaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "de.hybris.platform.savedorderformsoccaddon.hmc.locales";
