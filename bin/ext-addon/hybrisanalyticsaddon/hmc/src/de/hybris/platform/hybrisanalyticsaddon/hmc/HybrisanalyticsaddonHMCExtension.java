 ...
 *
 */
package de.hybris.platform.hybrisanalyticsaddon.hmc;
...
/**
 * Provides necessary meta information about the hybrisanalyticsaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.2.0.0
 */
public class HybrisanalyticsaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(HybrisanalyticsaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "de.hybris.platform.hybrisanalyticsaddon.hmc.locales";
