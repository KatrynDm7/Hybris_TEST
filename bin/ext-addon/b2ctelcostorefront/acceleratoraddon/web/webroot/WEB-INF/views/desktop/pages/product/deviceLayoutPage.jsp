...
<template:page pageTitle="${pageTitle}">
	...
	<telcoProduct:deviceProductDetailsPanel product="${product}"
	...
	<cms:pageSlot position="DeviceContentPosition" var="feature" element="div"
        class="span-24 deviceContentPosition cms_disp-img_slot">
        <cms:component component="${feature}" />
    </cms:pageSlot>
