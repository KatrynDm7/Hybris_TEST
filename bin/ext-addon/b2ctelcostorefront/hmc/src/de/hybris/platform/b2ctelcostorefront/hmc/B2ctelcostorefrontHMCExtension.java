 ...
 *
 */
package de.hybris.platform.b2ctelcostorefront.hmc;
...
/**
 * Provides necessary meta information about the b2ctelcostorefront hmc extension.
 * 
 * 
 * @version ExtGen v5.5.0.0-M3
 */
public class B2ctelcostorefrontHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(B2ctelcostorefrontHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "de.hybris.platform.b2ctelcostorefront.hmc.locales";
