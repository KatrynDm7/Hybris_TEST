 ...
 *
 */
package de.hybris.platform.accountsummaryaddon.controllers.cms;
...
import de.hybris.platform.accountsummaryaddon.controllers.AccountSummaryAddonControllerConstants;
...
public abstract class AbstractCMSComponentController<T extends AbstractCMSComponentModel> extends AbstractController
{
	...
	protected String getView(final T component)
	{
		...
		return AccountSummaryAddonControllerConstants.Views.Cms.ComponentPrefix + StringUtils.lowerCase(getTypeCode(component));
	}
