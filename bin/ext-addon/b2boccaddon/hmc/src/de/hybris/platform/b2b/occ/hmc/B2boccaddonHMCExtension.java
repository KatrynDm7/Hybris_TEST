 ...
 *  
 */
package de.hybris.platform.b2b.occ.hmc;
...
/**
 * Provides necessary meta information about the b2boccaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.2.0.0
 */
public class B2boccaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(B2boccaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "de.hybris.platform.b2b.occ.hmc.locales";
