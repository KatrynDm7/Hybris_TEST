...
<template:page pageTitle="${pageTitle}" navg="cart" schbox="cart" >
...
$(function(){
	...
	var options = {
			url: '${contextPath}/checkout/multi/cartdata',
			data: "",
			type: 'GET',
...
function showInvoiceInfo(data){
	...
	var invoiceModifyTxt = '<spring:theme code="checkout.order.settle.not.need.facture.modify" text=""/>';
	$('.btnModifyInvoice').html(invoiceModifyTxt);
	$('.invoiceBlock2').show();
}
...
function showInvoiceNUll(){
	...
	$('.btnModifyInvoice').show();
	var invoiceCreateTxt = '<spring:theme code="checkout.order.settle.not.need.facture.create" text=""/>';
	$('.btnModifyInvoice').html(invoiceCreateTxt);
...
$(function(){
		...
		function addNewAd(){
			...
			var options = {
				...
				{
					if(data=="timeout_1"){
						window.location.href="${contextPath}/login/checkout?islocalSubmit=1";
						return;
					}
                                	...
                                	<div class="orderSettlement_L">
                                        ...
                                        <div class="invoice">
                                            ...
                                            <ul class="invoiceBlock1">
                                            	...
                                            	<input type="radio" id="invoiceType" name="invoiceType" checked="checked" value="普通发票" /><spring:theme code="checkout.order.settle.commonFacture" text=""/></li>
                                                ...
                                                <input type="text" name="invoicMsg" id="invoicMsg" value="" /><span class="invoicMsg_span"><spring:theme code="checkout.order.settle.factureContent.null" text=""/></span></li>
                                            ...
                                            <div class="invoiceBtn">
                                            	...
                                            	<a href="javascript:void(0);" class="btnModifyInvoice"><spring:theme code="checkout.order.settle.not.need.facture.create" text=""/></a>
