 ...
 *
 */
package de.hybris.platform.chinaaccelerator.storefront.checkout.hmc;
...
/**
 * Provides necessary meta information about the chinacheckoutaddon hmc extension.
 *
 *
 * @version ExtGen v5.1.0.0-SNAPSHOT
 */
public class ChinacheckoutaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(ChinacheckoutaddonHMCExtension.class.getName());
