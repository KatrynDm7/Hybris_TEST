...
/**
 * Provides necessary meta information about the b2ctelcocheckoutaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.1.0.0-SNAPSHOT
 */
public class B2ctelcocheckoutaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(B2ctelcocheckoutaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "de.hybris.platform.storefront.hmc.locales";
