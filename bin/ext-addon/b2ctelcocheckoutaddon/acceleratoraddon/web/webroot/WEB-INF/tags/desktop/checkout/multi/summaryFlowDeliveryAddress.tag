...
<div class="summaryDeliveryAddress span-8">
	...
	<c:if test="${hasShippedItems}">
		<ycommerce:testId code="checkout_changeAddress_element">
			...
			<a href="${editAddressUrl}/?editAddressCode=${deliveryAddress.id}" class="editButton"><spring:theme code="checkout.summary.edit"/></a>
		</ycommerce:testId>
	</c:if>
</div>