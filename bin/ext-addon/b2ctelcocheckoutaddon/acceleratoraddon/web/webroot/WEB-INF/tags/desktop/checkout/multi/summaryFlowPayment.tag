...
<div class="summaryPayment span-8 last"  data-security-what-text="${securityWhatText}">
    ...
    <ycommerce:testId code="checkout_changePayment_element">
        ...
        <a href="${addPaymentMethodUrl}" class="editButton"><spring:theme code="checkout.summary.edit"/></a>
    </ycommerce:testId>
</div>
