	...
	public String enterStep(final Model model, final RedirectAttributes redirectAttributes) throws CMSItemNotFoundException
	{
		...
		if (CheckoutPciOptionEnum.HOP.equals(subscriptionPciOption))
		{
			...
			try
			{
				...
				return B2bacceleratoraddonControllerConstants.Views.Pages.MultiStepCheckout.HostedOrderPostPage;
			}
		...
		else if (CheckoutPciOptionEnum.SOP.equals(subscriptionPciOption))
		{
			...
			try
			{
				...
				return B2bacceleratoraddonControllerConstants.Views.Pages.MultiStepCheckout.SilentOrderPostPage;
			}
			catch (final Exception e)
			{
				LOG.error("Failed to build beginCreateSubscription request", e);
		...
		return B2bacceleratoraddonControllerConstants.Views.Pages.MultiStepCheckout.AddPaymentMethodPage;
	}
