...
<div class="span-19">
	<div class="headline">
		<spring:theme code="text.account.orderApprovalDetails.orderStatusDetails.label"/>
		</h1>
	</div>
	<div class="span-9">
		<table class="table_budget orderListTable">
			<tr>
				<td><spring:theme code="text.account.orderApprovalDetails.OrderNumber"/>:</td>
				<td>${orderApprovalData.b2bOrderData.code}</td>
			</tr>
			<tr>
				<td><spring:theme code="text.account.orderApprovalDetails.orderPlacedBy"/>:</td>
				<td>${orderApprovalData.b2bOrderData.b2bCustomerData.name}</td>
			</tr>
			<tr>
				<td><spring:theme code="text.account.orderApprovalDetails.purchaseOrderNumber"/>:</td>
	...
	<div class="span-9 right last">
		<table class="table_budget orderListTable">
			<tr>
				<td><spring:theme code="text.account.orderApprovalDetails.parentBusinessUnit" />:</td>
			...
			<c:if test="${orderApprovalData.b2bOrderData.paymentType.code eq 'ACCOUNT'}">
				<tr>
					<td><spring:theme code="text.account.orderApprovalDetails.costCenter" />:</td>
					<td>${orderApprovalData.b2bOrderData.costCenter.code}</td>
				</tr>
				<tr>
					<td><spring:theme code="text.account.orderApproval.orderStatus" />:</td>
