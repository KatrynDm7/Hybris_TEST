		...
		<c:choose>
			<c:when test="${not empty orderHistoryEntries}">
				<table class="orderListTable">
					<thead>
						<tr>
							<th><spring:theme code="text.account.orderHistoryEntry.date"/></th>
							<th><spring:theme code="text.account.orderHistoryEntry.user"/></th>
							<th><spring:theme code="text.account.orderHistoryEntry.email"/></th>
							<th><spring:theme code="text.account.orderHistoryEntry.comment"/>
							</th>
							<th><spring:theme code="text.account.orderHistoryEntry.status"/>
							</th>
							<c:if test="${isQuoteNegotiation eq true}">
								<th><spring:theme code="text.account.orderHistoryEntry.Quote.value"/>
								</th>
							</c:if>
						</tr>
					</thead>
