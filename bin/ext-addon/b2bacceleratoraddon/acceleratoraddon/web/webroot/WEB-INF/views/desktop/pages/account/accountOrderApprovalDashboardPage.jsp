		...
		<c:choose>
				...
				<form>
					<table id="order_history" class="orderListTable">
						<thead>
							<tr>
								<th id="header1"><spring:theme code="text.account.orderApprovalDashBoard.orderNumber" /></th>
								<th id="header2"><spring:theme code="text.account.order.purchase" /></th>
								<th id="header3"><spring:theme code="text.account.orderApprovalDashBoard.purchaseOrderNumber" /></th>
								<th id="header4"><spring:theme code="text.account.orderApprovalDashBoard.orderCreated" /></th>
								<th id="header5"><spring:theme code="text.account.orderApprovalDashBoard.orderStatus" /></th>
								<th id="header6"><spring:theme code="text.account.orderApprovalDashBoard.actions" /></th>
							</tr>
						</thead>
						<tbody>
								...
								<tr>
									...
									<td headers="header6">
										<ycommerce:testId code="orderApprovalDashboard_Actions_links">
											<ul class="updates">
												<li><a href="orderApprovalDetails/${order.workflowActionModelCode}"><spring:theme code="text.view"/></a></li>
											</ul>
										</ycommerce:testId>
									</td>
								</tr>
