...
import de.hybris.platform.chinaaccelerator.social.jiathis.jalo.GeneratedJiathisManager;
...
/**
 * This is the extension manager of the Jiathis extension.
 */
public class JiathisManager extends GeneratedJiathisManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(JiathisManager.class.getName());
	 ...
	 */
	public static JiathisManager getInstance()
	{
		return (JiathisManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				JiathisConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public JiathisManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of JiathisManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of JiathisManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of JiathisManager called, current tenant: " + getTenant().getTenantID());
		}
	}
