 ...
 *  
 */
package de.hybris.platform.acceleratorwebservicesaddon.hmc;
...
/**
 * Provides necessary meta information about the acceleratorwebservicesaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.1.0.0-SNAPSHOT
 */
public class AcceleratorwebservicesaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(AcceleratorwebservicesaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "de.hybris.platform.acceleratorwebservicesaddon.hmc.locales";
