...
<%@ taglib prefix="product" tagdir="/WEB-INF/tags/addons/b2bpunchoutaddon/desktop/product" %>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<%@ taglib prefix="common" tagdir="/WEB-INF/tags/addons/b2bpunchoutaddon/desktop/common" %>
