...
@IntegrationTest
public class C4cServerTest extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("C4cServerTest-log");
			robotSettings.setOutputName("C4cServerTest-output");
			robotSettings.setReportName("C4cServerTest-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/opt/bamboo-agent/xml-data/build-dir/MAINTNG-TD570-PCS/bin/ext-atddtests/c4ccustomeratddtests/genresources/robottests/C4cServerTest.txt"));
		}
	...
	@Test
	public void DatahubConnection_Test()
	{
		modelService.detachAll();
		
		final String robotTestName = "DatahubConnection_Test";
	...
	@Test
	public void C4CIntegration_Test()
	{
		modelService.detachAll();
		
		final String robotTestName = "C4CIntegration_Test";
	...
	@Test
	public void C4CIntegration_Test_Only_first_Name()
	{
		modelService.detachAll();
		
		final String robotTestName = "C4CIntegration_Test_Only_first_Name";
