	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/opt/bamboo-agent/xml-data/build-dir/MAINTNG-TD570-PCS/bin/ext-atddtests/financialacceleratorstorefrontatddtests/genresources/robottests/InsuranceQuotation_Test.txt"));
		}
